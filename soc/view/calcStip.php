<div class = "input-group divCenter">
    <p>Из-за многочисленных просьб сделать приложение на iOS, да и просто из-за того, что существующее приложение такое себе, можете пользоваться этим для расчета рейтинга.</p>
