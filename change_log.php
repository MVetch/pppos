...
?>
<ul>
<li>Изменения на 07.07.2020</li>
	<ul>
		<li>В список факультетов добавлен&nbsp;<b>Университетский колледж (УК)</b>.</li>
	</ul>
	<li>Изменения на 26.03.2018</li>
	<ul>
		<li>Ура! Ура! Очень вовремя, но судя по разговорам все еще актуально. Теперь можно <b>расчитывать свой учебный рейтинг</b>. Ссылка в личном кабинете в правом меню.</li>
	</ul>
	<li>Изменения на 30.12.2017</li>
	<ul>
		<li>В разделе ПГАС теперь можно сделать себе <b>Excel-документ со своими баллами</b></li>
	</ul>
	<li>Изменения на 25.11.2017</li>
	<ul>
		<li>Наконец-то можно восстанавливать пароль по-человечески! Нужно при входе нажать на "Забыли пароль?" и следовать простым инструкциям.</li>
		<li>Обновленный протокол стипкома для профоргов</li>
		<li><b>Сайт переезжает на новый адрес</b> <a href="http://профкомлгту.рф">профкомлгту.рф</a>. Пора поменять адрес закладки в браузере.</li>
	</ul>
	<li>Изменения на 30.09.2017</li>
        <ul>
            <li>Добавлена возможность обрезать фотографию при загрузке для того, чтобы она подходила для рамки в личном кабинете.</li>
        </ul>
